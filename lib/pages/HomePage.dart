      ...
      body: Container(
        ...
        child: Column(
          children: [
            ...
            // List of schedules (Jadwal Pengambilan Sampah)
            Expanded(
...
// Schedule Card Widget (for Jadwal Pengambilan Sampah)
      ...
      child: Column(
        ...
        children: [
          ...
          Padding(
            padding: const EdgeInsets.all(16.0),
            child: Text(
              schedule.wasteBankName, // Change to use wasteBankName from the Schedule class
